...
module alu(
    ...
    assign alu_add  = alu_control[ 3]&&alu_control[ 2]&&alu_control[ 1]&&alu_control[ 0];  //1111
    assign alu_sub  = alu_control[ 3]&&alu_control[ 2]&&alu_control[ 1]&&!alu_control[ 0];  //1110
    assign alu_slt  = alu_control[ 3]&&alu_control[ 2]&&!alu_control[ 1]&&alu_control[ 0];  //1101
    assign alu_sbt  = alu_control[ 3]&&alu_control[ 2]&&!alu_control[ 1]&&!alu_control[ 0];  //1100 大于置位
    assign alu_sltu = alu_control[ 3]&&!alu_control[ 2]&&alu_control[ 1]&&alu_control[ 0];  //1011
    assign alu_and  = alu_control[ 3]&&!alu_control[ 2]&&alu_control[ 1]&&!alu_control[ 0];  //1010
    assign alu_nor  = alu_control[ 3]&&!alu_control[ 2]&&!alu_control[ 1]&&alu_control[ 0];  //1001
    ...
    assign alu_wxor  = !alu_control[ 3]&&alu_control[ 2]&&alu_control[ 1]&&!alu_control[ 0];  //0110 同或
    assign alu_sll  = !alu_control[ 3]&&alu_control[ 2]&&!alu_control[ 1]&&alu_control[ 0];  //0101  
    assign alu_srl  = !alu_control[ 3]&&alu_control[ 2]&&!alu_control[ 1]&&!alu_control[ 0];  //0100  
    assign alu_lli  = !alu_control[ 3]&&!alu_control[ 2]&&alu_control[ 1]&&alu_control[ 0];  //0011  低位加载
    assign alu_sra  = !alu_control[ 3]&&!alu_control[ 2]&&alu_control[ 1]&&!alu_control[ 0];  //0010   
    assign alu_lui  = !alu_control[ 3]&&!alu_control[ 2]&&!alu_control[ 1]&&alu_control[ 0];  //0001 
    ...
    //
    assign wxor_result = alu_src1 ^~ alu_src2;//两数按位同或
    assign lli_result = {16'd0, alu_src2[15:0]};//移位至低半字节
...
//add,sub,slt,sltu均使用该模块
    ...
    assign sbt_result[0]    = ~((alu_src1[31] & ~alu_src2[31]) | (~(alu_src1[31]^alu_src2[31]) & adder_result[31]));    
