...
HD_PWD='D:/vivado_project1/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regfile_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source regfile_display.tcl
