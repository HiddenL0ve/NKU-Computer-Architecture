...
#
# Generated by Vivado on Fri May 17 10:47:55 +0800 2024
...
# Script info
echo -e "inst_rom.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim inst_rom -key {Behavioral:sim_1:Functional:inst_rom} -tclbatch cmd.tcl -log simulate.log
}
