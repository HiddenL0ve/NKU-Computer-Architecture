...
HD_PWD='D:/vivado_project/project7_multi_cycle_cpu/multi_cycle_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_cycle_cpu_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_cycle_cpu_display.tcl
