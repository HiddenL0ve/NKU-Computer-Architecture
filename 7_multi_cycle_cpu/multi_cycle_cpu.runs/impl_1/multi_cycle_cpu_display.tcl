...
set rc [catch {
  ...
  add_files -quiet D:/vivado_project/project7_multi_cycle_cpu/multi_cycle_cpu.runs/synth_1/multi_cycle_cpu_display.dcp
...
set rc [catch {
  ...
  catch {file copy -force debug_nets.ltx multi_cycle_cpu_display.ltx}
