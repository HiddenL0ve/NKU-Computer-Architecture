...
HD_PWD='D:/vivado_project/project7_multi_cycle_cpu/multi_cycle_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_cycle_cpu_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_cycle_cpu_display.tcl -notrace
